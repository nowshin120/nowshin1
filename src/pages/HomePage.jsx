...
export default function HomePage({ activeCategory, searchQuery }) {
  ...
  return (
    <>
      <div className="mx-auto max-w-7xl px-4 py-5 pb-28 sm:px-6 sm:py-6 sm:pb-32 lg:px-8 lg:py-8 lg:pb-8">
